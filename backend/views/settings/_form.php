        ...
        <div class="col-lg-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="general">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <?= $form->field($model, 'contact_info')->textarea(['rows' => 6, 'maxlength' => true, 'id' => 'elm1']) ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a href="" id="thumb-image1" data-toggle="image" class="img-thumbnail">
                                <img src="<?php echo $model->app_logo; ?>" alt="" width="125" height="125" title="" data-placeholder="no_image.png" />
                            </a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a href="" id="thumb-image2" data-toggle="image" class="img-thumbnail">
                                <img src="<?php echo $model->footer_logo; ?>" alt="" width="125" height="125" title="" data-placeholder="no_image.png" />
                            </a>
