                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        <strong
                                            ...
                                            Dear customer,
                                            <br/>
                                            you have received item sharing from your friend  "<?= $sharing->name ?>" with below information.
                                            <br/>
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        <p>Item Name: <strong><?= $sharing->item->name ?></strong></p>
                                        <p>Item Link: <strong><a href="<?= $setting->website ?>/#/catalog/product-view/<?= $sharing->item->id.'/'.$sharing->item->seo_url ?>">View Item</a> </strong></p>
                                        <p>Message: <strong><?= $sharing->message ?></strong></p>
                                    </td>
                                </tr>
