...
class Items extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['seller_id', 'category_id', 'age_id', 'usage_id', 'condition_id', 'status', 'area_id', 'favoriteCount', 'visitCount'], 'integer'],
            [['isFeatured'], 'integer'],
            [['description'], 'string'],
            [['age_id', 'usage_id', 'condition_id'], 'default', 'value' => 0],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'favoriteCount' => Yii::t('app', 'Favorite Count'),
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getItemAge()
    {
        return $this->hasOne(ItemAges::className(), ['id' => 'age_id']);
    }
    ...
    {
        return $this->hasOne(ItemConditions::className(), ['id' => 'condition_id']);
    }
