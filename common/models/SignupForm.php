...
class SignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['picture', 'phone_number', 'country_code', 'dob', 'country', 'gender', 'last_name', 'company_name', 'company_logo', 'company_location', 'company_contact', 'package_id'], 'safe'],
    ...
    public function sendEmail($user) {
        ...
        (new EmailHelper() )->sendEmail($user->email, [], 'Welcome to Yii2 Boilerplate!', 'account/signup', [ 'user' => $user]);
    }
}
