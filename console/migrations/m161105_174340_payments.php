...
class m161105_174340_payments extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%payments}}', [
            ...
            'expire_on'            => $this->integer()->notNull(),
            'status'                => $this->string(),
        ], $tableOptions);
        ...
        $this->createIndex('package_index', '{{%payments}}', 'package_id');
        $this->addForeignKey('package_FK', '{{%payments}}', 'package_id', 'packages', 'id', 'CASCADE', 'CASCADE');
