...
/**
 * @property \core\controllers\BaseRestController $owner
 */
...
use api\core\components\filters\auth\ApiBasicAuth;
...
class OAuth2AccessFilter extends \yii\base\ActionFilter
{
    ...
    public function beforeAction($action)
    {
        ...
        list($publicActions, $actionsScopes) = $this->analyzeAccessRules($actionName);
     ...
     * @author Nadeem Akhtar <nadeem@myswich.com>
     */
    protected function analyzeAccessRules($currentAction)
    {
        $accessRules = $this->owner->accessRules();
        $publicActions = [];
        $actionsScopes = [];
